package ad.helper; /******************************************************************************
 *  Compilation:  javac ad.helper.BinaryStdIn.java
 *  Execution:    java ad.helper.BinaryStdIn < input > output
 *  Dependencies: none             
 *
 *  Supports reading binary data from standard input.
 *
 *  % java ad.helper.BinaryStdIn < input.jpg > output.jpg
 ...
 * byte first) order.
 * <p>
 * The client should not intermix calls to {@code ad.helper.BinaryStdIn} with calls
...
public final class BinaryStdIn {
    ...
    public static void close() {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Could not close ad.helper.BinaryStdIn");
        }
    }
